...
temp  <- read.sas7bdat("M:/Millennial_panel/05_Scratch/pool2.sas7bdat")
colnames(temp)

temp$distCBD8090 <- exp(temp$ln_dist_cbd8090)-1
temp$distCBD9000 <- exp(temp$ln_dist_cbd9000)-1
temp$distCBD0010 <- exp(temp$ln_dist_cbd0010)-1
...
migrdata <- migrdata[complete.cases(migrdata[, c("Migr_youngest", "Migr_young", "Migr_midlife", "Migr_middle", 
                                                 "CC8090", "CC9000", "CC0010", 
                                                 "distCBD8090", "distCBD9000", "distCBD0010",
                                                 ...
                                                 "elem", "pctnhw", "pctforeign", 
                                                 "lnmedhhinc", "pctunemp", "pctmulti", "yr8090", "yr9000", "yr0010", 
                                                 "UA01", "UA02", "UA03", "UA04", "UA05", 
                                                 "UA06", "UA07", "UA08", "UA09", "UA10", 
                                                 "UA11", "UA12", "UA13", "UA14", "UA15", 
                                                 "UA16", "UA17", "UA18", "UA19", "UA20")]), ]

migrdata <- migrdata[, c("decade", "UA", "UAname", "stcnttr", "Migr_youngest", "Migr_young", "Migr_midlife", "Migr_middle", 
                         "CC8090", "CC9000", "CC0010", "distCBD8090", "distCBD9000", "distCBD0010", 
                         "lnpden8090", "lnpden9000", "lnpden0010", 
                         "One_Transit8090", "One_Transit9000", "One_Transit0010", 
                         "lnpop100",  "pctyoungestbg", "pctyoungbg", "pctmidlifebg", "pctmiddlebg", 
                         "elem", "pctnhw", "pctforeign", 
...
#identical(names(a), names(c))
#identical(names(b), names(c))

#geodata.all <- rbind(geodata8090@data, geodata9000@data, geodata0010@data) 

#qregspiv01 <- qregspiv(form, wmat=wmat01, tau=0.1, nboot=100, alpha=0.5, data=geodataUA01)
#qregspiv02 <- qregspiv(form, wmat=wmat, tau=0.2, nboot=100, alpha=0.5, data=geodata)
#qregspiv03 <- qregspiv(form, wmat=wmat, tau=0.3, nboot=100, alpha=0.5, data=geodata)
#qregspiv04 <- qregspiv(form, wmat=wmat, tau=0.4, nboot=100, alpha=0.5, data=geodata)
#qregspiv05 <- qregspiv(form, wmat=wmat01, tau=0.5, nboot=100, alpha=0.5, data=geodataUA01)
#qregspiv06 <- qregspiv(form, wmat=wmat, tau=0.6, nboot=100, alpha=0.5, data=geodata)
#qregspiv07 <- qregspiv(form, wmat=wmat, tau=0.7, nboot=100, alpha=0.5, data=geodata)
#qregspiv08 <- qregspiv(form, wmat=wmat, tau=0.8, nboot=100, alpha=0.5, data=geodata)
#qregspiv09 <- qregspiv(form, wmat=wmat01, tau=0.9, nboot=100, alpha=0.5, data=geodataUA01)
#qregspiv09[2:10, c(1, 3)]

#stargazer(qregspiv01, qregspiv05, qregspiv09, type="text",  
...
form <- Migr_young ~  
  CC8090 + CC9000 + CC0010 + lnpden8090 + lnpden9000 + lnpden0010 + One_Transit8090 + One_Transit9000 + One_Transit0010 + 
...
form2 <- Migr_young ~ 
  CC8090 + CC9000 + CC0010 + lnpden8090 + lnpden9000 + lnpden0010 + One_Transit9000 + One_Transit0010 + 
  lnpop100 + pctyoungbg + pctnhw + pctforeign + pctmulti + elem + yr9000 + yr0010  
form3 <- Migr_young ~  
  CC8090 + CC9000 + CC0010 + lnpden8090 + lnpden9000 + lnpden0010 + One_Transit0010 + 
  lnpop100 + pctyoungbg + pctnhw + pctforeign + pctmulti + elem + yr9000 + yr0010   
form4 <- Migr_young ~ 
...
write.csv(q25, file="./key_output/by_decade/qregspiv_young_2000s_q25.csv")
...
write.csv(q50, file="./key_output/by_decade/qregspiv_young_2000s_q50.csv")
...
write.csv(q75, file="./key_output/by_decade/qregspiv_young_2000s_q75.csv")
...
df8090 <- df[c(9, 10, 19, 20, 29, 30), c(2:4, 30)] # <- to generate regression tables 
...
write.csv(q05b, file="./key_output/by_decade/qregspiv_young_2000s_q05b.csv")
write.csv(q10b, file="./key_output/by_decade/qregspiv_young_2000s_q10b.csv")
write.csv(q15b, file="./key_output/by_decade/qregspiv_young_2000s_q15b.csv")
write.csv(q20b, file="./key_output/by_decade/qregspiv_young_2000s_q20b.csv")
write.csv(q25b, file="./key_output/by_decade/qregspiv_young_2000s_q25b.csv")
...
write.csv(q50b, file="./key_output/by_decade/qregspiv_young_2000s_q50b.csv")
...
write.csv(q75b, file="./key_output/by_decade/qregspiv_young_2000s_q75b.csv")
...
df<- NULL
df <- join_all(list(q05b, q10b, q15b, q20b, q25b, q30b, q35b, q40b, q45b, q50b, 
                    q55b, q60b, q65b, q70b, q75b, q80b, q85b, q90b, q95b), by='rn', type='full') 
row.names(df) <- df$rn
df$rn <- NULL
df <- as.data.frame(t(df))
#df9000 <- df[c(seq(1, 37, by=2)), 2:4]
df9000 <- df[c(9, 10, 19, 20, 29, 30), c(2:4, 30)] # <- to generate regression tables 
...
df <- NULL
df <- join_all(list(q05c, q10c, q15c, q20c, q25c, q30c, q35c, q40c, q45c, q50c, 
                    q55c, q60c, q65c, q70c, q75c, q80c, q85c, q90c, q95c), by='rn', type='full') 
row.names(df) <- df$rn
df$rn <- NULL
df <- as.data.frame(t(df))
#df0010 <- df[c(seq(1, 37, by=2)), 2:4]
df0010 <- df[c(9, 10, 19, 20, 29, 30), c(2:4, 30)] # <- to generate regression tables 
...
write.csv(test, file="./key_output/qregspiv_youngest_3decades.csv")
...
migrdata2 <- subset(temp, pctforeign<=100)# & yr8090==1 & UA01==1)
colnames(migrdata2)

migrdata2 <- migrdata2[complete.cases(migrdata2[, c("Migr_youngest", "Migr_young", "Migr_midlife", "Migr_middle", 
                                                 "f_ccity9000b", "f_ccity0010b", "f_pden9000b", "f_pden0010b", 
                                                 "f_pt9000b", "f_pt0010b", "lncden9000b", "lncden0010b", 
                                                 "lnpop100", "pctyoungestbg", "pctyoungbg", "pctmidlifebg", "pctmiddlebg", 
                                                 "pctnhw", "pctforeign", "elem", 
                                                 "lnmedhhinc", "pctunemp", "pctmulti", "yr8090", "yr9000", "yr0010", 
                                                 "UA01", "UA02", "UA03", "UA04", "UA05", 
                                                 "UA06", "UA07", "UA08", "UA09", "UA10", 
                                                 "UA11", "UA12", "UA13", "UA14", "UA15", 
...
migrdata2 <- migrdata2[, c("decade", "UA", "UAname", "stcnttr", "Migr_youngest", "Migr_young", "Migr_midlife", "Migr_middle", 
                         "f_ccity9000b", "f_ccity0010b", "f_pden9000b", "f_pden0010b", 
                         "f_pt9000b", "f_pt0010b", "lncden9000b", "lncden0010b", 
                         "lnpop100",  "pctyoungestbg", "pctyoungbg", "pctmidlifebg", "pctmiddlebg", 
                         "pctnhw", "pctforeign", "lnmedhhinc", "pctunemp", 
                         "pctmulti", "elem", "yr8090", "yr9000", "yr0010", 
                         "UA01", "UA02", "UA03", "UA04", "UA05", 
                         "UA06", "UA07", "UA08", "UA09", "UA10", 
                         "UA11", "UA12", "UA13", "UA14", "UA15", 
                         "UA16", "UA17", "UA18", "UA19", "UA20")]
...
df <- join_all(list(q05b2, q10b2, q15b2, q20b2, q25b2, q30b2, q35b2, q40b2, q45b2, q50b2, 
                    q55b2, q60b2, q65b2, q70b2, q75b2, q80b2, q85b2, q90b2, q95b2), by='rn', type='full') 

df <- join_all(list(q25b2, q50b2, q75b2), by ='rn', type='full') # <- to generate regression tables 
row.names(df) <- df$rn
df$rn <- NULL
df <- as.data.frame(t(df))
#df90002 <- df[c(seq(1, 37, by=2)), 2:5]
df90002 <- df[, c(2:5, 31)] # <- to generate regression tables 
...
df <- join_all(list(q05c2, q10c2, q15c2, q20c2, q25c2, q30c2, q35c2, q40c2, q45c2, q50c2, 
                    q55c2, q60c2, q65c2, q70c2, q75c2, q80c2, q85c2, q90c2, q95c2), by='rn', type='full') 
...
df00102 <- df[, c(2:5, 31)] # <- to generate regression tables 
